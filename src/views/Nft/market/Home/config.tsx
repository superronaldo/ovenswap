  ...
  return [
    ...
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.ovenswap.fi/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by PancakeSwap from sales are used to buy back and BURN OVE tokens in our weekly OVE burns.',
        ),
        t(
