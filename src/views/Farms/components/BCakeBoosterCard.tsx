...
export const BCakeBoosterCard = () => {
  ...
  const tooltipContent = (
    <>
      <Box mb="20px">
        {t(
          'Yield Boosters allow you to boost your farming yields by locking OVE in the fixed-term staking OVE pool. The more OVE you lock, and the longer you lock them, the higher the boost you will receive.',
        )}
      </Box>
      <Box>
    ...
    return (
      <Box>
        ...
        <Text color="textSubtle" fontSize={12} mb="16px">
          {t('An active fixed-term OVE staking position is required for activating farm yield boosters.')}
        </Text>
