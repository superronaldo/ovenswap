...
export const multiQuery = async (
  ...
  console.log("multiQuery fetchedData: ", subqueries)
  try {
    while (!allFound) {
      ...
      console.log("multiQuery result: ", result)
      fetchedData = {
        ...fetchedData,
        ...result,
      }
    ...
    console.log("multiQuery fetchedData: ", fetchedData)
    return fetchedData
  } catch (error) {
    console.log("multiQuery fetchedData: ", null)
